...
export const CHECKPOINT_DEFINITIONS: CheckpointDefinition[] = [
  ...
  // ============================================================
  {
    ...
    applies_to: ["garasje_carport", "tilbygg", "paabygg", "enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "bruksendring", "terrasse_balkong", "stoettemur", "uthus_anneks", "naust", "riving", "fasadeendring"],
  ...
  },
  {
    ...
    applies_to: ["tilbygg", "paabygg", "enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "bruksendring", "fasadeendring"],
  ...
  // ============================================================
  {
    ...
    category: "formelle_forhold",
    description: "Kontroller at faktisk fasadeutforming, materialer og fargevalg stemmer overens med godkjente fasadetegninger.",
  ...
  },
  {
    ...
    category: "plassering",
    description: "Kontroller at fasadeendringen er i tråd med reguleringsplanens krav til estetikk, materialbruk og fargesetting. Sjekk ev. krav i bebyggelsesplan eller SEFRAK-register.",
    applies_to: ["fasadeendring"],
    required_tags: [],
    severity: "warning",
  ...
  },
  {
    ...
    category: "teknisk",
    description: "Kontroller at eventuelle nye vinduer eller dører tilfredsstiller U-verdikrav i TEK17, og at totalt energitap ikke øker.",
    applies_to: ["fasadeendring"],
    required_tags: [],
    severity: "info",
  ...
  // ============================================================
  {
    ...
    applies_to: ["garasje_carport", "tilbygg", "paabygg", "enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "terrasse_balkong", "stoettemur", "uthus_anneks", "naust"],
  ...
  },
  {
    ...
    applies_to: ["garasje_carport", "tilbygg", "paabygg", "enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "stoettemur", "uthus_anneks", "naust"],
    required_tags: [],
    severity: "warning",
    legal_reference: "pbl § 29-4",
  },
  ...
  // ============================================================
  {
    ...
    applies_to: ["garasje_carport", "tilbygg", "paabygg", "enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "terrasse_balkong", "uthus_anneks", "naust"],
    required_tags: [],
    severity: "critical",
  ...
  },
  {
    ...
    applies_to: ["garasje_carport", "tilbygg", "paabygg", "enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "uthus_anneks", "naust"],
    required_tags: [],
    severity: "warning",
  ...
  // ============================================================
  {
    ...
    applies_to: ["enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "tilbygg", "garasje_carport", "stoettemur", "naust"],
    required_tags: [],
    severity: "critical",
  ...
  },
  {
    ...
    applies_to: ["enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "tilbygg", "paabygg"],
    required_tags: [],
    severity: "critical",
  ...
  // ============================================================
  {
    ...
    applies_to: ["garasje_carport", "tilbygg", "paabygg", "enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "bruksendring"],
  ...
  },
  {
    ...
    applies_to: ["enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "bruksendring", "tilbygg", "paabygg"],
    required_tags: [],
    severity: "critical",
  ...
  // ============================================================
  {
    ...
    category: "brann",
    description: "Kontroller at brannskillekonstruksjonen mellom de to boenhetene (vegg/etasjeskiller) har riktig brannklasse (minimum EI 60) og er uten hull eller svake punkter.",
  ...
  },
  {
    ...
    category: "teknisk",
    description: "Kontroller at lydisolasjon mellom boenheter er prosjektert og utført i samsvar med TEK17. Krav: Rw ≥ 55 dB for luftlyd, L''n,w ≤ 53 dB for trinnlyd.",
    applies_to: ["tomannsbolig", "leilighetsbygg"],
  ...
  },
  {
    ...
    description: "Kontroller at begge boenheter har separate innganger og at adkomstforhold er i samsvar med søknaden.",
  ...
  // ============================================================
  {
    ...
    applies_to: ["enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "tilbygg", "paabygg", "bruksendring"],
  ...
  },
  {
    ...
    applies_to: ["enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "tilbygg", "garasje_carport", "naust"],
    required_tags: [],
    severity: "warning",
  ...
  },
  {
    ...
    applies_to: ["enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "tilbygg", "paabygg", "garasje_carport", "stoettemur", "naust"],
  ...
  },
  {
    ...
    applies_to: ["enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "tilbygg", "bruksendring"],
    required_tags: ["har_va_overvann"],
    severity: "warning",
  ...
  },
  {
    ...
    applies_to: ["enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "tilbygg", "stoettemur", "naust"],
    required_tags: ["har_terrengendring"],
    severity: "warning",
  ...
  // ============================================================
  {
    ...
    applies_to: ["garasje_carport", "tilbygg", "paabygg", "enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "bruksendring", "terrasse_balkong", "uthus_anneks", "naust", "fasadeendring"],
  ...
  },
  {
    ...
    applies_to: ["enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "tilbygg", "paabygg", "bruksendring", "fasadeendring"],
    required_tags: [],
    severity: "info",
    legal_reference: "TEK17 kap 14",
  },
  ...
  // ============================================================
  {
    ...
    category: "teknisk",
    description: "Kontroller at radonsperre er lagt under gulv mot grunn, og at evt. avtrekksrør for radonventilering er installert i samsvar med prosjektering og TEK17 § 13-5.",
    applies_to: ["enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "tilbygg", "paabygg", "bruksendring", "garasje_carport"],
  ...
  // ============================================================
  {
    ...
    applies_to: ["enebolig", "tomannsbolig", "leilighetsbygg", "naeringsbygg", "tilbygg", "bruksendring"],
  ...
  },
  {
    ...
    applies_to: ["terrasse_balkong", "tilbygg", "paabygg", "enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg"],
    required_tags: [],
    severity: "critical",
  ...
  // ============================================================
  {
    ...
    applies_to: ["garasje_carport", "tilbygg", "paabygg", "enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "bruksendring", "terrasse_balkong", "stoettemur", "uthus_anneks", "naust", "fasadeendring"],
    required_tags: ["soeknadspliktig"],
    severity: "warning",
  ...
  },
  {
    ...
    applies_to: ["tilbygg", "paabygg", "enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "bruksendring"],
    required_tags: ["har_ansvarlige_foretak"],
    severity: "warning",
    legal_reference: "SAK10 § 14-8",
  },
  {
    ...
    applies_to: ["garasje_carport", "tilbygg", "paabygg", "enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "bruksendring", "uthus_anneks", "naust", "fasadeendring"],
    required_tags: [],
    severity: "info",
    legal_reference: "pbl § 31-3",
  },
  ...
  // ============================================================
  {
    ...
    category: "formelle_forhold",
    description: "Kontroller at vesentlige byggevarer (bærende elementer, isolasjon, vinduer, membraner m.m.) er CE-merket og at ytelseserklæring (DoP) foreligger på byggeplassen. Gjelder produkter som er dekket av harmoniserte produktstandarder.",
    applies_to: ["tilbygg", "paabygg", "enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "bruksendring"],
    required_tags: ["har_ansvarlige_foretak"],
    severity: "warning",
  ...
  // ============================================================
  {
    ...
    category: "formelle_forhold",
    description: "Kontroller at ansvarlig foretak har tilpassede kvalitetssikringsrutiner for dette tiltaket (sjekklister, prosedyrer for avviksbehandling m.m.) og at disse er i aktiv bruk på byggeplassen, jf. SAK10 § 10-1.",
    applies_to: ["tilbygg", "paabygg", "enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "bruksendring"],
    required_tags: ["har_ansvarlige_foretak"],
    severity: "info",
  ...
  // ============================================================
  {
    ...
    category: "plassering",
    description: "Kontroller at tiltaket er plassert og sikret i henhold til krav om sikkerhet mot flom, skred (snø-, jord- og steinskred), stormflo og erosjon. Verifiser at sikkerhetsnivå (nominell årlig sannsynlighet) er oppfylt og at geoteknisk/hydrologisk vurdering er dokumentert.",
    applies_to: ["enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "tilbygg", "paabygg", "garasje_carport", "naust"],
  ...
  // ============================================================
  {
    ...
    category: "formelle_forhold",
    description: "Kontroller at uavhengig kontrollerende er angitt i søknaden, at kontrollplan foreligger, og at stikkprøvekontroll er gjennomført for påkrevde kontrollområder (konstruksjoner, geoteknikk, brannsikkerhet, fuktsikring av våtrom).",
    applies_to: ["tilbygg", "paabygg", "enebolig", "tomannsbolig", "leilighetsbygg", "fritidsbolig", "naeringsbygg", "bruksendring"],
    required_tags: ["har_ansvarlige_foretak"],
    severity: "warning",
  ...
  // ============================================================
  {
    ...
    category: "brann",
    description: "Kontroller at byggets risikoklasse (RKL) og brannklasse (BKL) er korrekt fastslått og lagt til grunn for brannteknisk prosjektering. Flermannsboliger er normalt risikoklasse 4.",
  ...
  // ============================================================
  {
    ...
    en_title: "Risk class and fire class correctly determined",
    category: "brann",
    description: "Kontroller at byggets risikoklasse (RKL) og brannklasse (BKL) er korrekt fastslått og lagt til grunn for brannteknisk prosjektering. Risikoklasse avhenger av byggets bruk og antall personer.",
